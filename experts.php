...
<html lang="en-US">
<head>
    <title>OnlinAssignmenthelp.com - Experts</title>
  ...
  <link rel="canonical" href="https://www.onlineassignmenthelp.com/experts.php" />
         ...
         <div class="experts-online-inner-sections animated zoomIn">
              <div class="connect-width-experts">
                <span class="connect-head">
                    Connect with our Writers Available 24x7
                </span>
        ...
        <div class="experts-inner-views animatable zoomIn">
           <div class="left-top-sections">
               ...
               <span class="left-bottm-section-contains">
                   <span class="lt-ft-bt animatable ">
                       One Day pre-submission is the foremost responsibility of our Premium writers.This is one area of responsibility where they never fail. </span>
               </span>
           </div>
           <div class="right-top-sections">
               ...
               <span class="right-tp-section-contains">
                   <span class="rt-ft-bt animatable">
                      Ability to deliver high Distinction Quality Assignment with perfect structure.Our writer's secret is their exemplary language.
                   </span>
               </span>
           </div>
           <div class="left-bottoms-sections">
               ...
               <span class="left-botts-section-contains">
                   <span class="lt-bt-ft-bt animatable">
                      Our writers have obtained their degree from worldwide reputed universities,
                      And They exactly know how to pair up their expertise with their Intelligence.
                   </span>
               </span>
           </div>
           <div class="right-bottoms-sections">
               ...
               <span class="rt-bottss-section-contains">
                   ...
                   Each Assignment has been carefully proofread with special inputs by our writers,which makes them more valuable and different from others.
                   </span>
               </span>
           </div>
        </div>
                ...
                <div class="common-table-details-sections">
                    <table cellspacing="0" class="deatils-tables-experts ">
                        ...
                        <tbody class="tbodys experts">
					        ...
					        $sql_rev = "SELECT * FROM `expert_data`;";
